                ...
                <View style={styles.modalContainer}>
                    ...
                    <View style={styles.buttonGroup}>
                        <View style={styles.column}>
                            <Pressable style={ageGroup == 1 ? styles.groupActiveButton : styles.groupInactiveButton}>
                            ...
                            <Pressable style={ageGroup == 3 ? styles.groupActiveButton : styles.groupInactiveButton}>
                            ...
                            <Pressable style={ageGroup == 5 ? styles.groupActiveButton : styles.groupInactiveButton}>
                            ...
                            <Pressable style={ageGroup == 7 ? styles.groupActiveButton : styles.groupInactiveButton}>
                        ...
                        <View style={styles.column}>
                            <Pressable style={ageGroup == 2 ? styles.groupActiveButton : styles.groupInactiveButton}>
                            ...
                            <Pressable style={ageGroup == 4 ? styles.groupActiveButton : styles.groupInactiveButton}>
                            ...
                            <Pressable style={ageGroup == 6 ? styles.groupActiveButton : styles.groupInactiveButton}>
                            ...
                            <Pressable style={ageGroup == 8 ? styles.groupActiveButton : styles.groupInactiveButton}>
